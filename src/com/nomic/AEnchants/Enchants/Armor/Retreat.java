...
public class Retreat implements Listener {
	...
	public void onPlayerHit(EntityDamageByEntityEvent e) {
		...
		String one = names.getConfigurationSection("Retreat").getString("one");
		String two = names.getConfigurationSection("Retreat").getString("two");
		String three = names.getConfigurationSection("Retreat").getString("three");
